<!-- Timeline -->
<div class="bg-prime-bg py-20">
    <div class="container mx-auto">
        <div class="max-w-[85rem]">
            <h2 class="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl uppercase">My Work Expriance
            </h2>
            <div class="flex gap-10 items-center">
                <div class="areaone">
                    <img src="{{ asset('images/workarea.jpg') }}" alt="">
                </div>
                <div class="areatwo">
                    <!-- Item -->
                    <div class="group relative flex gap-x-5 py-10">
                        <!-- Icon -->
                        <div
                            ...
                            <div class="relative z-10 size-6 flex justify-center items-center">
                                <svg class="shrink-0 size-6 text-gray-50" width="32" height="32"
                        ...
                        <div class="grow pb-8 group-last:pb-0">
                            <h3 class="mb-1 text-xs text-gray-50">
                                2023 - Present
                            </h3>
                            ...
                            <ul class="list-disc ms-6 mt-3 space-y-1.5">
                                <li class="ps-1 text-sm text-gray-50">
                    ...
                    <div class="group relative flex gap-x-5">
                        ...
                        <div
                            class="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200">
                            <div class="relative z-10 size-6 flex justify-center items-center">
                                <svg class="shrink-0 size-6 text-gray-100" xmlns="http://www.w3.org/2000/svg"
