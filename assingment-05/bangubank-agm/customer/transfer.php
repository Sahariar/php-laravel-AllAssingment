...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (empty($errorMessage)) {
		...
		$notfType = "Transfer";
		$notfMessage = "Transfer with $$amount to $email from $user_email";
		$setNotification = $notification->addNotification($_SESSION['user_id'], $notfType, $notfMessage);
    }
}
							...
							<div class="mt-4 text-sm text-gray-500">
								<form action="transfer.php" method="POST">
									...
									<div class="relative mt-4 md:mt-8">
										...
										<input type="number" name="amount" id="amount" class="block w-full ring-0 outline-none pl-4 py-2 md:pl-8 text-gray-800 border-b border-b-<?php echo $_SESSION['color'] ;?>-500 placeholder:text-gray-400 md:text-4xl" step="0.01" placeholder="0.00" required />
									</div>
