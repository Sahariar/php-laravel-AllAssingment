...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
  ...
  if (empty($errorMessage)) {
    $accountManager->transferBalance($amount, $_SESSION['userId'], $reciverData['userId']);
  }
}
$currentBalance = $accountManager->showBalanceById($_SESSION['userId']);
// $transactionsData = $accountManager->showTransactionsByEmail($_SESSION['email']);
