...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
	...
	if (empty($errorMessage)) {
		$accountManager->addDeposit($amount, $_SESSION['userId'], $_SESSION['userId']);
	}
}
			...
			<nav class="border-b border-<?php echo $_SESSION['color'] ?>-300 border-opacity-25 bg-<?php echo $_SESSION['color'] ?>-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
						...
						<div class="flex items-center px-2 lg:px-0">
							<div class="hidden sm:block">
								<div class="flex space-x-4">
									...
									<a href="./deposit.php" class="bg-<?php echo $_SESSION['color']; ?>-700 text-white rounded-md py-2 px-3 text-sm font-medium">Deposit</a>
				...
				<div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
					<div class="space-y-1 pt-2 pb-3">
						...
						<a href="./deposit.php" class="bg-<?php echo $_SESSION['color']; ?>-700 text-white block rounded-md py-2 px-3 text-base font-medium">Deposit</a>
