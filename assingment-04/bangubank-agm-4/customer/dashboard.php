...
$transactionsData = $accountManager->showTransactionsById($_SESSION['userId']);
?>
<!DOCTYPE html>
      ...
      <nav class="border-b border-<?php echo $_SESSION['color'] ?>-300 border-opacity-25 bg-<?php echo $_SESSION['color'] ?>-600" x-data="{ mobileMenuOpen: false, userMenuOpen: false }">
            ...
            <div class="flex items-center px-2 lg:px-0">
              <div class="hidden sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="./dashboard.php" class="bg-<?php echo $_SESSION['color']; ?>-700 text-white rounded-md py-2 px-3 text-sm font-medium" aria-current="page">Dashboard</a>
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 pt-2 pb-3">
            <a href="./dashboard.php" class="bg-<?php echo $_SESSION['color']; ?>-700 text-white block rounded-md py-2 px-3 text-base font-medium" aria-current="page">Dashboard</a>
          ...
          <div class="border-t border-<?php echo $_SESSION['color']; ?>-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              ...
              <button type="button" class="ml-auto flex-shrink-0 rounded-full bg-<?php echo $_SESSION['color']; ?>-700 p-1 text-<?php echo $_SESSION['color']; ?>-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-<?php echo $_SESSION['color']; ?>-600">
